...
class SendLog(BaseModel, JSONFieldMixin, table=True):
    ...
    def mark_sent(
        self, telegram_message_id: Optional[int] = None, telegram_chat_id: Optional[int] = None
    ) -> None:
    ...
    def mark_failed(
        ...
        telegram_error_code: Optional[str] = None,
    ) -> None:
    ...
    def can_retry(self) -> bool:
        ...
        return (
            self.status in [SendStatus.FAILED, SendStatus.RATE_LIMITED]
